...
class XAxis extends Base{
    ...
    protected $maxPadding = 0.01;
    
    protected $maxZoom = null;
    
    protected $min = null;
    
    protected $minPadding = 0.01;
    ...
    protected $tickPixelInterval = 100;
    ...
    public function setTitle($title, $optionsTitle = null) {
        ...
        if($optionsTitle != null){
            foreach($optionsTitle as $optionTitle){
                $method = 'set'.ucfirst($optionTitle);
                if(method_exists($newTitle, $method)){  
                    $newTitle->$method($optionTitle);
                }else{
